  ...
  <AppLayout>
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-4 py-6">
      ...
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 class="text-2xl font-black text-white">Neue Bilder</h1>
          <p class="text-xs text-gray-500">Die neuesten Uploads der Inserate</p>
        </div>
      </div>
      ...
      <div v-if="images.data.length" class="columns-2 sm:columns-3 md:columns-4 lg:columns-5 gap-2 space-y-2">
        ...
        >
          ...
          <div v-if="image.visibility === 'private'"
            ...
            <span class="text-[10px] text-[#e35d8f] font-bold">Privat</span>
          </div>
      ...
      <div v-else class="text-center py-20 text-gray-600">
        ...
        <p class="text-lg">Keine Bilder gefunden.</p>
      </div>
