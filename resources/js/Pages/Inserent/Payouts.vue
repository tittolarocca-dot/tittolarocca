<template>
  <AppLayout>
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
      ...
      <!-- Bank Details Form -->
      <div v-if="showBankForm" class="bg-white rounded-xl border border-gray-200 p-6 mb-6 shadow-sm">
      ...
      <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        ...
        <div v-if="payouts.length === 0" class="text-center py-12 text-gray-400">
          ...
          <p class="text-xs mt-1 text-gray-400">Auszahlungen werden monatlich generiert (Minimum CHF 50).</p>
        </div>
