          ...
          <div class="p-4">
            ...
            <div v-if="activeTab === 'public'">
              ...
              <template v-else>
                ...
                <div v-else-if="publicMedia.length === 2"
                  class="grid grid-cols-2 gap-1 h-[270px] rounded-xl overflow-hidden">
                ...
                <div v-else-if="publicMedia.length <= 4"
                  class="flex gap-1 h-[270px] rounded-xl overflow-hidden">
                ...
                <!-- 5+ items -->
                <div v-else class="flex gap-1 h-[270px] rounded-xl overflow-hidden">
            ...
            <div v-if="activeTab === 'private'">
              ...
              <template v-else-if="privateMediaCount > 0">
                <div class="relative h-[270px] rounded-xl overflow-hidden">
