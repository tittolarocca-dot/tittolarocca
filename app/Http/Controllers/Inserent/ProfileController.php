...
class ProfileController extends Controller
{
    ...
    private function validateProfile(Request $request): array
    {
        return $request->validate([
            ...
            'gender'                 => ['nullable', 'string', 'in:Frau,Mann,Transgender,Divers'],
            'sexuality'              => ['nullable', 'string', 'in:Heterosexuell,Bisexuell,Homosexuell'],
            'body_type'              => ['nullable', 'string', 'in:Schlank,Sportlich,Kurvig,Mollig'],
            'height_cm'              => ['nullable', 'integer', 'min:140', 'max:220'],
            'weight_kg'              => ['nullable', 'integer', 'min:40', 'max:200'],
            'smoker'                 => ['nullable', 'string', 'in:Nichtraucher*in,Raucher*in,Gelegenheitsraucher*in'],
